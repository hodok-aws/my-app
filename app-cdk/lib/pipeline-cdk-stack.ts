import { Stack, StackProps, CfnOutput, aws_codeconnections as codeconnections } from 'aws-cdk-lib'
...
export class PipelineCdkStack extends Stack {
  constructor(scope: Construct, id: string, props: ConsumerProps) {
    ...
    const organizationName = this.node.tryGetContext('organizationName')
